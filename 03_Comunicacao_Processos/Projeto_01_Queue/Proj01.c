...
/*
** NUM_ITERACOES corresponde ao numero de mensagens que serao enviadas.
** Se este numero cresce, o tempo de execucao tambem cresce.
*/
#define NUM_ITERACOES	1000

/*
** MICRO_POR_SEGUNDO define o numero de microsegundos em um segundo
*/
#define MICRO_POR_SEGUNDO	1000000

/*
** MSG_QUEUE_ID, e uma chave arbitraria, foi escolhido um numero qualquer,
...
int main (int argc, char *argv[])
{
    ...
    **
    ** OBS:  Os filhos herdarao a informacao sobre a fila estabelecida no pai!
    */
    rtn = 1;
    ...
    for (count = 0; count < 2; count++)
    {
        if (rtn != 0)
        {
            ...
            ** o fork() returns a positive value, the process ID of the child process, to the parent.
...
** mensagem (mtype) que sera uma identificacao de mensagem. No caso em questao,
** este sera sempre o mesmo. O segundo e uma matriz com tamanho
    ...
    */
    for (count = 0; count < NUM_ITERACOES; count++)
    {
        ...
        */
        ...
        delta += (receive_time.tv_usec - data_ptr->send_time.tv_usec) / (float)MICRO_POR_SEGUNDO;
        total += delta;
